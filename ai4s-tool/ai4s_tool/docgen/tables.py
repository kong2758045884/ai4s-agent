...
One pipeline turns a raw :class:`~ai4s_tool.docgen.model.TableBlock` into a
...
if TYPE_CHECKING:
    from ai4s_tool.docgen.model import TableBlock
    from ai4s_tool.docgen.themes import Theme
