...
picks) into a complete, contrast-safe :class:`~ai4s_tool.docgen.themes.Theme`
...
:func:`~ai4s_tool.docgen.themes.get_theme` resolves by name.
...
from ai4s_tool.docgen.slides import relative_luminance
from ai4s_tool.docgen.themes import (
    BUILTIN_THEMES,
    Theme,
    get_theme,
