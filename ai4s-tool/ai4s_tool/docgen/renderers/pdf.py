...
- Fonts are guaranteed via :class:`~ai4s_tool.docgen.fonts.FontManager`
...
- Native vector math: display equations are drawn as real PDF vector paths
  (glyph outlines + fraction/radical bars from :mod:`ai4s_tool.docgen.mathtext`)
...
from ai4s_tool.docgen.fonts import get_font_manager
from ai4s_tool.docgen.images import resolve_image
from ai4s_tool.docgen.markdown import InlineSpan, parse_inline
...
from ai4s_tool.docgen.themes import CALLOUT_COLORS, get_theme
...
def render_pdf(spec: DocumentSpec, output_path: Path) -> dict[str, Any]:
    ...
    class _VectorMathFlowable(Flowable):
        ...
        :func:`~ai4s_tool.docgen.mathtext.math_vector_path` directly on the
