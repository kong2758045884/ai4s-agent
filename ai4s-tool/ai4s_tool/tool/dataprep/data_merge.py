...
from ai4s_tool.tool.dataprep._data import build_result, extend_input_schema, load_records
...
class DataMergeTool(SyncTool):
    ...
    def _execute_merge(
        ...
        # LLM often passes a bare string; iterating a str yields characters.
