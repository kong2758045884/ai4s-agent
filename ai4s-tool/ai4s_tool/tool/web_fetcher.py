...
DEFAULT_USER_AGENT = "AI4SToolWebFetch/1.0"
TRUNCATED_SUFFIX = "\n\n[内容已截断，完整正文请查看附件文件。]"
...
class WebFetcher:
    ...
    def __init__(self, inline_content_limit: int | None = None):
        ...
        self.proxy = os.getenv("AI4S_WEB_FETCH_PROXY", "").strip()
        self.reddit_session = _reddit_session_cookie(os.getenv("AI4S_REDDIT_SESSION", ""))
