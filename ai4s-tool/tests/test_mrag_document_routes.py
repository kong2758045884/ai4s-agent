...
from ai4s_tool.tool.mrag.api.routes import document as document_module
from ai4s_tool.tool.mrag.enums.source_type_enums import SourceTypeEnum
from ai4s_tool.tool.mrag.enums.task_status_enums import TaskStatusEnum
from ai4s_tool.tool.mrag.storage.models.kb_doc_model import (
    CANONICAL_FULL_TEXT_CHUNK_TYPE,
    KBDocModel,
)
from ai4s_tool.tool.mrag.storage.models.kb_file_model import KBFileModel
        ...
        with tempfile.TemporaryDirectory(prefix="mrag-web-test-") as temp_dir:
            ...
            with patch.object(
                ...
                with patch.object(
                    ...
                    with patch(
                        "ai4s_tool.tool.mrag.utils.crawl_utils.crawl",
                        return_value="# 网页标题\n\n正文",
                    ):
                        with patch.object(
                            document_module,
