...
| 文件路径 | 说明 |
|---------|------|
| `src/main/java/org/wwz/ai/trigger/http/ai4s/support/SseEmitterAgentSessionStream.java` | trigger 侧 SSE 协议适配 |
| `src/main/java/org/wwz/ai/trigger/http/ai4s/support/SseLifecycleSupport.java` | SSE 生命周期与心跳支持 |
