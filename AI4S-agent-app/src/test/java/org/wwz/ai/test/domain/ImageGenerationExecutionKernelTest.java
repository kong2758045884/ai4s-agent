...
import org.wwz.ai.domain.agent.ai4s.service.imagegeneration.impl.ImageGenerationExecutionKernelImpl;
...
public class ImageGenerationExecutionKernelTest {
    ...
    public void test_executeNormalizesGatewayRequestAndResponse() {
        IAI4SImageGenerationGateway gateway = Mockito.mock(IAI4SImageGenerationGateway.class);
        ...
        Assert.assertEquals("1024x1024", captured.get().getSize());
         Assert.assertNull(captured.get().getModel());
