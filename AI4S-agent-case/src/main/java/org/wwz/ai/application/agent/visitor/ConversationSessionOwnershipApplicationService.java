...
public class ConversationSessionOwnershipApplicationService {
    ...
    /**
     * 校验会话归属后软删除会话，避免客户端通过 sessionId 删除其他访客的会话。
     */
    public void deleteExistingSession(String visitorId, String sessionId) {
        ensureExistingSessionAccessible(visitorId, sessionId);
        executionLedgerWriteRepository.softDeleteSession(sessionId, visitorId);
    }
