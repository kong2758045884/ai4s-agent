...
import org.wwz.ai.domain.agent.ai4s.data.dto.ChatQueryColumn;
import org.wwz.ai.domain.agent.ai4s.data.dto.ChatQueryData;
import org.wwz.ai.domain.agent.ai4s.data.dto.ChatQueryFilter;
import org.wwz.ai.domain.agent.ai4s.data.dto.ChatSchemaDto;
import org.wwz.ai.domain.agent.ai4s.data.dto.NL2SQLReq;
import org.wwz.ai.domain.agent.ai4s.data.dto.NL2SQLResult;
import org.wwz.ai.domain.agent.ai4s.data.model.ComparisonType;
import org.wwz.ai.domain.agent.ai4s.data.model.DataOrderBy;
import org.wwz.ai.domain.agent.ai4s.data.model.ModelColumn;
import org.wwz.ai.domain.agent.ai4s.data.model.SqlModel;
import org.wwz.ai.domain.agent.ai4s.data.model.StandardColumnType;
import org.wwz.ai.domain.agent.ai4s.data.model.WhereCondition;
